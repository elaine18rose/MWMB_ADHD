...
mdlVig0=fitlme(probe_subtype_table,'Vigilance~1+Block+DIVASubtype+(1|SubID)');
mdlVig1=fitlme(probe_subtype_table,'Vigilance~1+Block*DIVASubtype+(1|SubID)');
...
for vigilance_level = vigilance_levels
    % Get counts for ADHD inn group (for the current vigilance level)
    adhd_inn_vigilance = sum(probe_subtype_table.Vigilance == vigilance_level & probe_subtype_table.DIVASubtype == 'Inattention');
    % Get counts for ADHD com group (for the current vigilance level)
    adhd_com_vigilance = sum(probe_subtype_table.Vigilance == vigilance_level & probe_subtype_table.DIVASubtype == 'Combined');

    % Get counts for ADHD group that did not select the current vigilance level
    adhd_inn_not_vigilance = sum(probe_subtype_table.Vigilance ~= vigilance_level & probe_subtype_table.DIVASubtype == 'Inattention');
    % Get counts for Control group that did not select the current vigilance level
    adhd_com_not_vigilance = sum(probe_subtype_table.Vigilance ~= vigilance_level & probe_subtype_table.DIVASubtype == 'Combined');

    % Create the contingency table (2x2 matrix)
    count_matrix = [adhd_inn_vigilance, adhd_inn_not_vigilance; 
                    adhd_com_vigilance, adhd_com_not_vigilance];
