...
%%
all_RT = [Hit_RT_CTR , Hit_RT_ADHD]'; 
all_Group=[zeros(1,length(Hit_RT_CTR)) , ones(1,length(Hit_RT_ADHD))]';
...
%%
all_stdRT = [stdRT_CTR, stdRT_ADHD]'; 
all_Group=[zeros(1,length(stdRT_CTR)) , ones(1,length(stdRT_ADHD))]';
