...
format_fig;
set(gca, 'FontSize', 25);
title(['ERP NoGo vs Go - Pz'], 'FontSize',32);
...
% Save figure
saveas(gcf, [pwd filesep 'Figures' filesep 'Fig3_PanelA_ERP.svg']); %!! When you get a chance, reimport in inkscape because this should be Fig3 not fig2
